...
const Contact = () => {
  return (
     <section style={{ marginTop: "35%" }} className='py-16 lg:section' id='contact'>
      ...
      <div className='flex flex-col lg:flex-row'>
        ...
        className='flex-1 border rounded-2xl flex flex-col gap-y-6 pb-24 p-6 items-start'>
          ...
          {/* <a href="mailto:farrukhmukhammadkulov@gmail.com"><button className='btn btn-lg'>Send Message</button></a> */}
          <a href="mailto:farrukhmukhammadkulov@gmail.com?subject='Hello'&body='Send me a question' " className='btn btn-lg flex items-center'>Send</a>
